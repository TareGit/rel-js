...
abstract class CommandWithOptions extends CommandBase {
...
export abstract class SlashCommand extends CommandWithOptions {
  group: string
...
export abstract class UserContextMenuCommand extends CommandWithOptions {
...
export abstract class ChatContextMenuCommand extends CommandBase {
...
export class CommandsModule extends BotModule {
  ...
  async beginLoad(): Promise<void> {
    ...
    await this.uploadCommands("669640893745201168")
  ...
  static COMMAND_GROUPS = Object.values(constants.COMMAND_GROUPS)
  ...
  async importCommand(importPath: string) {
