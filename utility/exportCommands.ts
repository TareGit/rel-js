...
utils.log("Emulated dev enviroment and loaded raw commands, count :", commands.length)
...
fs.writeFileSync('commands.json', JSON.stringify({ commands: editedCommands }, null, 2));
